...
questions = fields.Str(required=False)
answers = fields.Str(required=False)

questionsRequired = fields.Str(required=True)
answersRequired = fields.Str(required=True)
